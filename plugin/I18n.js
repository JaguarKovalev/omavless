...
var CATALOG = {
  ...
  "native.support.exportWarning": {"en":"Enter an absolute file path. An existing regular file will be replaced. The report contains no profile links or credentials.","ru":"Введите абсолютный путь к файлу. Существующий обычный файл будет заменён. Отчёт не содержит ссылок и ключей профилей."},
