...
var CATALOG = {
  ...
  "native.support.scope": {"en":"Counts, preferences and available local runtime observations. No profile links or credentials; Internet and DNS protection are not verified.","ru":"Счётчики, настройки и доступные локальные наблюдения. Без ссылок и ключей профилей; Интернет и защита DNS не проверяются."},
  ...
  "native.settings.modeHelp": {"en":"The selected mode changes only after the runtime confirms it. Changing mode while connected may require system authorization.","ru":"Выбранный режим изменится только после подтверждения со стороны Rust. При активном подключении система может запросить авторизацию."},
  ...
  "native.main.unavailable": {"en":"Native migration acceptance is in progress. Fresh-login and Python-free acceptance remain pending.","ru":"Приёмка переноса на Rust продолжается. Ещё предстоят проверка нового входа в систему и полный прогон без Python."},
  ...
  "native.quit.description": {"en":"Disconnect VPN, stop the runtime and disable this plugin. Profiles and settings are kept.","ru":"Отключить VPN, остановить runtime и выключить плагин. Профили и настройки сохранятся."},
  ...
  "native.fileExport.path": {"en":"Absolute destination path","ru":"Полный путь к файлу"},
  ...
  "native.ping.loading": {"en":"Waiting for a TUN-bound ICMP reply…","ru":"Ожидание ответа ICMP через TUN…"},
  "native.ping.unavailable": {"en":"ICMP sample unavailable. This does not mean the VPN failed.","ru":"Замер ICMP недоступен. Это не означает отказ VPN."},
  "native.ping.observed": {"en":"Last 10 TUN-bound ICMP samples; no reply is not proof of a VPN failure.","ru":"Последние 10 замеров ICMP через TUN; отсутствие ответа не доказывает отказ VPN."},
  ...
  "traffic.native_note": {"en":"Interface totals include Direct and routed traffic; these are not proxy-only usage or a connection health check.","ru":"Счётчики интерфейса включают прямой и маршрутизируемый трафик. Это не расход только через прокси и не проверка соединения."},
