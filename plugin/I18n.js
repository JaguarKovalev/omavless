...
var CATALOG = {
  ...
  "native.helpers.scope": {"en":"Tools for file import, profile editing and QR codes.","ru":"Инструменты для импорта файлов, редактирования профилей и QR-кодов."},
  ...
  "native.supportExport.pending": {"en":"Saving report…","ru":"Сохранение отчёта…"},
  ...
  "native.support.export": {"en":"Save support report","ru":"Сохранить отчёт для поддержки"},
  "native.support.title": {"en":"Support report","ru":"Отчёт для поддержки"},
  "native.support.scope": {"en":"Settings and local diagnostic data, without profile links or credentials.","ru":"Настройки и локальные данные диагностики, без ссылок и ключей профилей."},
  "native.support.save": {"en":"Save file","ru":"Сохранить файл"},
  "native.support.copy": {"en":"Copy report","ru":"Копировать отчёт"},
  "native.support.loading": {"en":"Preparing report…","ru":"Подготовка отчёта…"},
  "native.support.copied": {"en":"Report copied to clipboard.","ru":"Отчёт скопирован в буфер обмена."},
  ...
  "native.state.connected": {"en":"CONNECTED","ru":"ПОДКЛЮЧЕНО"},
  ...
  "native.main.modeLabel": {"en":"Connection mode","ru":"Режим подключения"},
  "common.select": {"en":"Select","ru":"Выбрать"},
  "native.profile.active": {"en":"Connected profile: {name}","ru":"Подключённый профиль: {name}"},
  ...
  "native.subscriptions.scope": {"en":"Browse imported subscriptions and their profiles. Adding, updating and editing subscriptions will return in a separate native UI checkpoint.","ru":"Здесь можно просмотреть импортированные подписки и их профили. Добавление, обновление и редактирование подписок вернутся отдельным этапом интерфейса Rust."},
  "native.subscriptions.empty": {"en":"No imported subscriptions.","ru":"Импортированных подписок нет."},
  ...
  "native.quit.title": {"en":"Shut down OmaVLESS","ru":"Выключить OmaVLESS"},
  "native.quit.action": {"en":"Quit","ru":"Выйти"},
  "native.quit.running": {"en":"Shutting down…","ru":"Выключение…"},
  "native.quit.description": {"en":"Disconnect VPN and turn off this plugin. Profiles and settings are kept.","ru":"Отключить VPN и выключить плагин. Профили и настройки сохранятся."},
  "native.quit.confirmation": {"en":"Shut down OmaVLESS? VPN will disconnect, the runtime and its automatic startup will be disabled, and this plugin will close. Profiles and settings are kept. Starting again requires re-enabling the runtime and plugin.","ru":"Выключить OmaVLESS? VPN отключится, runtime и его автозапуск будут выключены, плагин закроется. Профили и настройки сохранятся. Для повторного запуска нужно включить runtime и плагин."},
  "native.quit.failed": {"en":"Shutdown was not completed. The plugin was not deliberately hidden before cleanup. Check runtime state; do not assume VPN is off. Runtime restart may be needed.","ru":"Выход не завершён. Плагин не скрывается до проверки очистки. Проверьте состояние: VPN мог остаться включённым. Может потребоваться запуск runtime."},
  "native.diagnostics.scope": {"en":"Read-only snapshot from Mihomo. Use Refresh to update it.","ru":"Снимок состояния Mihomo только для чтения. Для обновления нажмите «Обновить»."},
  "native.diagnostics.provider.loaded": {"en":"loaded","ru":"загружен"},
  "native.diagnostics.provider.empty": {"en":"empty","ru":"пусто"},
  "native.diagnostics.provider.unknown": {"en":"unknown","ru":"неизвестно"},
  ...
  "native.controls": {"en":"Native connection, profile controls and new-profile import. Subscription management and other tools are still being migrated.","ru":"Подключение, управление профилями и импорт новых профилей через Rust. Управление подписками и остальные инструменты ещё переносятся."},
  "native.importClipboard": {"en":"Import from clipboard","ru":"Импорт из буфера"},
  "native.importFile": {"en":"Import from file","ru":"Импорт из файла"},
  "native.importName": {"en":"Add a new profile named {name}","ru":"Добавить новый профиль с именем {name}"},
  "native.importBusy": {"en":"Waiting for import input or checking preview…","ru":"Ожидание данных или проверка предпросмотра…"},
  "native.importError.input": {"en":"Use one supported profile link, at most 32 KiB of UTF-8 text.","ru":"Укажите одну поддерживаемую ссылку профиля: не более 32 КиБ текста UTF-8."},
  "native.importError.stale": {"en":"Runtime state changed. Cancel and start import again.","ru":"Состояние изменилось. Отмените импорт и начните снова."},
  "native.importError.subscription": {"en":"This is a subscription link. Native subscription management is not available yet; no subscription was added.","ru":"Это ссылка подписки. Управление подписками через Rust пока недоступно; подписка не добавлена."},
  "native.importError.duplicateSubscription": {"en":"This subscription is already added. Nothing was changed.","ru":"Эта подписка уже добавлена. Ничего не изменено."},
  "native.importError.picker": {"en":"File picker missing. Run “omarchy pkg add zenity” in a terminal. Clipboard import still works.","ru":"Нет средства выбора файлов. Выполните «omarchy pkg add zenity» в терминале. Импорт из буфера по-прежнему работает."},
  "native.importError.clipboard": {"en":"Clipboard reader missing. Run “omarchy pkg add wl-clipboard” in a terminal.","ru":"Нет средства чтения буфера. Выполните «omarchy pkg add wl-clipboard» в терминале."},
  "native.importError.source": {"en":"Could not read import input. Check the clipboard or choose a readable UTF-8 text file.","ru":"Не удалось прочитать данные. Проверьте буфер или выберите доступный текстовый файл UTF-8."},
  "native.pin": {"en":"Pin","ru":"Закрепить"},
  "native.editor.open": {"en":"Edit profile","ru":"Изменить профиль"},
  "native.editor.reopen": {"en":"Reopen edited text","ru":"Открыть изменённый текст"},
  "native.editor.discard": {"en":"Discard edited text","ru":"Удалить черновик изменений"},
  "native.editor.privateDraft": {"en":"Edited text is private and held only in this panel session. Reopen to recover it; Cancel keeps an existing edited draft. Saving requires the original unchanged state. Discard before starting over.","ru":"Текст изменений хранится приватно только в этом сеансе панели. Откройте его для восстановления; отмена не удаляет уже изменённый черновик. Сохранение требует неизменного исходного состояния. Чтобы начать заново, удалите черновик."},
  "native.editor.rejected": {"en":"The edit was not saved. Your bounded edited text is retained; reopen it to correct it or discard it.","ru":"Изменения не сохранены. Текст допустимого размера сохранён в черновике: откройте его для исправления или удалите."},
  "native.editor.stale": {"en":"The original state changed. Reopen to recover the text, but saving cannot overwrite newer state. Discard it before starting a fresh edit.","ru":"Исходное состояние изменилось. Откройте черновик для восстановления текста; сохранение не перезапишет более новое состояние. Перед новым редактированием удалите черновик."},
  "native.editor.unknown": {"en":"The save outcome is unknown. Check the original operation. After accepting refreshed state, you can reopen the text for recovery only; saving again is blocked until this draft is discarded.","ru":"Результат сохранения неизвестен. Проверьте исходную операцию. После принятия обновлённого состояния можно открыть текст только для восстановления; повторное сохранение заблокировано до удаления черновика."},
  "native.editor.missing": {"en":"Profile editor unavailable. Install zenity with “omarchy pkg add zenity”, then reopen the draft.","ru":"Редактор профиля недоступен. Установите zenity командой «omarchy pkg add zenity», затем откройте черновик."},
  "native.editor.unavailable": {"en":"The editor could not return valid text. Any earlier draft is retained. Content rejected by the helper's 64 KiB limit cannot be recovered here.","ru":"Редактор не вернул допустимый текст. Предыдущий черновик сохранён, если он был. Текст, отклонённый из-за ограничения редактора в 64 КиБ, здесь восстановить нельзя."},
  "native.unpin": {"en":"Unpin","ru":"Открепить"},
  "native.localReady": {"en":"Owned core and configuration verified locally. Internet and route protection are not verified.","ru":"Своё ядро и конфигурация проверены локально. Интернет и защита маршрутов не проверены."},
  "native.localStopped": {"en":"Owned core is stopped. Visible TUN interfaces: {count} (ownership not verified).","ru":"Своё ядро остановлено. Видимых TUN-интерфейсов: {count} (принадлежность не проверена)."},
  "native.localUnverified": {"en":"Local runtime state could not be fully verified.","ru":"Локальное состояние среды выполнения не удалось полностью проверить."},
  "native.pending": {"en":"Operation in progress. Complete any system authorization dialogs.","ru":"Операция выполняется. Подтвердите системные запросы авторизации, если они появятся."},
  "native.unknownOutcome": {"en":"The operation outcome is unknown. Refresh and review the current state before continuing.","ru":"Результат операции неизвестен. Обновите и проверьте текущее состояние перед продолжением."},
  "native.reconcile": {"en":"Check original operation","ru":"Проверить исходную операцию"},
  "native.acceptState": {"en":"Use reviewed state","ru":"Принять проверенное состояние"},
  "native.select": {"en":"Select","ru":"Выбрать"},
  ...
  "native.fileExport.title": {"en":"Export profile to file","ru":"Экспорт профиля в файл"},
  "native.fileExport.pickerUnavailable": {"en":"File picker missing. Install zenity, kdialog or yad; setup help is in Settings.","ru":"Нет диалога выбора файла. Установите zenity, kdialog или yad; инструкция — в настройках."},
  "native.supportExport.pickerUnavailable": {"en":"File picker missing. Install zenity, kdialog or yad; setup help is in Settings.","ru":"Нет диалога выбора файла. Установите zenity, kdialog или yad; инструкция — в настройках."},
  "native.fileExport.helperUnavailable": {"en":"Update the OmaVLESS package to use Save As.","ru":"Обновите пакет OmaVLESS, чтобы использовать «Сохранить как…»."},
  "native.supportExport.helperUnavailable": {"en":"Update the OmaVLESS package to use Save As.","ru":"Обновите пакет OmaVLESS, чтобы использовать «Сохранить как…»."},
  "native.fileExport.saveTitle": {"en":"Save profile — contains connection credentials","ru":"Сохранить профиль — содержит данные доступа"},
  "native.fileExport.warning": {"en":"This file contains connection credentials. Export only to a private location. An existing file will be replaced.","ru":"Файл содержит данные доступа. Сохраните его в личную папку. Существующий файл будет заменён."},
  "native.fileExport.pending": {"en":"Exporting private profile…","ru":"Экспорт приватного профиля…"},
  "native.fileExport.saved": {"en":"Profile exported to a private file","ru":"Профиль сохранён в приватный файл"},
  "native.fileExport.failed": {"en":"Could not export profile. Check the destination and try again.","ru":"Не удалось экспортировать профиль. Проверьте путь и повторите попытку."},
  "native.core.loading": {"en":"Checking installed core…","ru":"Проверка установленного ядра…"},
  "native.core.failed": {"en":"Core setup facts unavailable. Try Refresh.","ru":"Сведения об установке ядра недоступны. Нажмите «Обновить»."},
  "native.core.notChecked": {"en":"Core setup not checked","ru":"Установка ядра не проверена"},
  "native.core.missing": {"en":"Mihomo not found. Install it through your host's supported setup.","ru":"Mihomo не найден. Установите его штатным способом для вашей системы."},
  "native.core.versionUnknown": {"en":"Mihomo found; version unavailable","ru":"Mihomo найден; версия недоступна"},
  "native.core.version": {"en":"Installed version: {version}","ru":"Установленная версия: {version}"},
  "native.core.tun.present": {"en":"TUN device: present","ru":"Устройство TUN: обнаружено"},
  "native.core.tun.unavailable": {"en":"TUN device: unavailable","ru":"Устройство TUN: недоступно"},
  "native.core.tun.unknown": {"en":"TUN device: not verified","ru":"Устройство TUN: не проверено"},
  "native.core.capabilities.present": {"en":"Core file network capabilities: present","ru":"Сетевые права файла ядра: обнаружены"},
  "native.core.capabilities.missing": {"en":"Core file network capabilities: missing or incomplete","ru":"Сетевые права файла ядра: отсутствуют или неполны"},
  "native.core.capabilities.unknown": {"en":"Core file network capabilities: not verified","ru":"Сетевые права файла ядра: не проверены"},
  "native.core.capabilities.not_applicable": {"en":"Core file network capabilities: no core found","ru":"Сетевые права файла ядра: ядро не найдено"},
  "native.core.scope": {"en":"Desktop setup facts only. Runtime service permissions and actual TUN creation are not verified here; this is not connection health.","ru":"Только сведения об установке. Права службы и фактическое создание TUN здесь не проверяются; это не проверка VPN-соединения."},
  "native.details.open": {"en":"Profile details","ru":"Сведения о профиле"},
  "native.details.private": {"en":"Private profile details — do not share screenshots. This is saved configuration, not connection health.","ru":"Приватные сведения о профиле — не публикуйте снимки экрана. Это сохранённые настройки, а не проверка соединения."},
  "native.details.loading": {"en":"Loading profile details…","ru":"Загрузка сведений о профиле…"},
  "native.details.failed": {"en":"Profile details unavailable. Refresh and try again.","ru":"Сведения о профиле недоступны. Обновите и повторите попытку."},
  ...
  "native.ping.test": {"en":"Ping","ru":"Проверить"},
  "native.ping.timeout": {"en":"No reply","ru":"Нет ответа"},
  "native.ping.milliseconds": {"en":"{ms} ms","ru":"{ms} мс"},
  "native.ping.loading": {"en":"Measuring latency…","ru":"Измерение задержки…"},
  "native.ping.unavailable": {"en":"Latency measurement unavailable","ru":"Измерение задержки недоступно"},
  "native.ping.observed": {"en":"Recent ICMP measurements through the TUN interface","ru":"Последние замеры ICMP через интерфейс TUN"},
  ...
  "traffic.native_title": {"en":"TUN traffic","ru":"Трафик TUN"},
