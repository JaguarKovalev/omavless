...
Historical installed evidence below was reconciled from Draft PR #236. Its
observed failures and acceptance limits are preserved. Current main-screen
visibility is governed by the [deferred sections contract](../roadmap/MAIN_PANEL_DEFERRED_SECTIONS.md);
current migration status is in the [local R6 closure](R6_LOCAL_CLOSURE_2026-09-13.md).
