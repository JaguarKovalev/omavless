...
Historical evidence recovered from Draft PR #222 during local integration.
The observations below retain their original date and tested identities; the
remaining-work list is superseded by the [R6 local closure](R6_LOCAL_CLOSURE_2026-09-13.md)
and [publication candidate](R6_PUBLICATION_CANDIDATE_2026-09-13.md).
